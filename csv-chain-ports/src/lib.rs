//! Chain-neutral runtime adapter ports.
//!
//! This crate owns the contracts between protocol orchestration and chain
//! implementations. It deliberately contains no RPC configuration, factories,
//! networking clients, storage backends, or application dependencies.
