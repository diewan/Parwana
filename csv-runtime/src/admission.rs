//! Admission control for runtime work.
//!
//! This module is the runtime's pressure boundary. It rejects excess work before
//! protocol state is mutated, preventing RPC stalls or adversarial traffic from
//! amplifying into replay consumption, proof backlog, or mint starvation.
