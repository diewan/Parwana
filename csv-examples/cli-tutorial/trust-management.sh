...
echo "=============================================="
echo "  Parwana CLI - Trust Management Demo"
echo "=============================================="
echo ""
...
echo ""
echo "proof.cbor: YES - Generate with CLI:"
echo "  csv proof generate <chain> <SANAD_ID> -o proof.cbor"
...
echo "  - <height>: Block height - can be obtained from chain explorers or 'csv chain status <chain>'"
echo "  - <hash>: Block hash - can be obtained from chain explorers or 'csv chain status <chain>'"
echo ""
...
echo "  - Must obtain from Parwana team or official repositories"
echo ""
...
echo "  1. Contact the Parwana team for official trust packages"
echo "  2. Download from trusted sources (official Parwana repositories)"
...
echo "  → <height> and <hash> can be obtained from chain explorers or 'csv chain status <chain>'"
echo ""
