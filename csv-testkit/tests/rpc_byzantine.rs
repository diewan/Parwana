...
fn test_byzantine_stale_height_injection() {
    let reader = ByzantineRpcReader::new(ByzantineFaultMode::StaleHeightInjection { lag_blocks: 100 });
...
fn test_byzantine_combined_faults() {
    ...
    let stale_reader = ByzantineRpcReader::new(ByzantineFaultMode::StaleHeightInjection { lag_blocks: 50 });
...
fn test_byzantine_stale_height_saturating_sub() {
    ...
    let reader = ByzantineRpcReader::new(ByzantineFaultMode::StaleHeightInjection { lag_blocks: 1000 });
