...
use csv_adapter_core::{AdapterError, AdapterResult, ChainOps, MintAdapter, MintReceipt, MintStatus, ProofAdapter, TransactionStatus};
use csv_hash::Hash;
...
impl MintAdapter for BitcoinAdapter {
    async fn mint_commitment(&self, commitment: &csv_hash::commitment::Commitment) -> AdapterResult<Hash> {
