...
fn test_sdk_no_direct_bitcoin_adapter_imports() {
    ...
    assert!(!sdk_source.contains("use csv_bitcoin::config::BitcoinConfig"),
    ...
    assert!(!sdk_source.contains("use csv_bitcoin::ops::BitcoinBackend"),
        "SDK should not directly import BitcoinBackend - use factory instead");
    
    // Should use factory instead
    assert!(sdk_source.contains("csv_adapter_factory"),
...
fn test_sdk_no_direct_ethereum_adapter_imports() {
    ...
    assert!(!sdk_source.contains("use csv_ethereum::config::EthereumConfig"),
    ...
    assert!(!sdk_source.contains("use csv_ethereum::ops::EthereumBackend"),
...
fn test_sdk_no_direct_aptos_adapter_imports() {
    ...
    assert!(!sdk_source.contains("use csv_aptos::config::AptosConfig"),
        "SDK should not directly import AptosConfig - use factory instead");
    
    // Should not import csv_aptos::ops::AptosBackend directly
    assert!(!sdk_source.contains("use csv_aptos::ops::AptosBackend"),
...
fn test_sdk_no_direct_solana_adapter_imports() {
    ...
    assert!(!sdk_source.contains("use csv_solana::config::SolanaConfig"),
        "SDK should not directly import SolanaConfig - use factory instead");
    
    // Should not import csv_solana::ops::SolanaBackend directly
    assert!(!sdk_source.contains("use csv_solana::ops::SolanaBackend"),
...
fn test_sdk_uses_adapter_build_result() {
    ...
    assert!(sdk_source.contains("AdapterBuildResult"),
...
fn test_sdk_registers_chain_adapter() {
    ...
    assert!(sdk_source.contains("register_adapter"),
