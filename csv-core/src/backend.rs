...
pub struct ContractStatus {
    ...
    /// Chain-specific metadata (operational; not canonical).
...
mod tests {
    ...
    fn test_transaction_status_serialization() {
        ...
        // JSON serialization test removed - serde_json not allowed in core per AGENTS.md
        // Use ciborium (CBOR) for canonical serialization instead
        let mut buf = Vec::new();
