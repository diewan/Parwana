...
impl AdversarialTestFramework {
    ...
    fn run_single_attack(&self, config: &AdversarialTestConfig, iteration: u32) -> Result<bool, String> {
        match config.scenario {
            ...
            AdversarialScenario::ProofManipulation => self.test_proof_manipulation(config, iteration),
            AdversarialScenario::TimestampManipulation => self.test_timestamp_manipulation(config, iteration),
    ...
    fn test_double_spend(&self, _config: &AdversarialTestConfig, _iteration: u32) -> Result<bool, String> {
    ...
    /// Test replay attack.
    fn test_replay_attack(&self, _config: &AdversarialTestConfig, _iteration: u32) -> Result<bool, String> {
    ...
    fn test_proof_manipulation(&self, _config: &AdversarialTestConfig, _iteration: u32) -> Result<bool, String> {
    ...
    fn test_timestamp_manipulation(&self, _config: &AdversarialTestConfig, _iteration: u32) -> Result<bool, String> {
    ...
    fn test_invalid_signature(&self, _config: &AdversarialTestConfig, _iteration: u32) -> Result<bool, String> {
    ...
    fn test_malformed_proof(&self, _config: &AdversarialTestConfig, _iteration: u32) -> Result<bool, String> {
    ...
    fn test_race_condition(&self, _config: &AdversarialTestConfig, _iteration: u32) -> Result<bool, String> {
    ...
    fn test_front_running(&self, _config: &AdversarialTestConfig, _iteration: u32) -> Result<bool, String> {
    ...
    fn test_griefing(&self, _config: &AdversarialTestConfig, _iteration: u32) -> Result<bool, String> {
    ...
    /// Test sybil attack.
    fn test_sybil_attack(&self, _config: &AdversarialTestConfig, _iteration: u32) -> Result<bool, String> {
...
fn test_proof_manipulation_defense() {
    ...
    assert!(result.success_rate < 0.1, "Proof manipulation defense failed");
...
fn test_invalid_signature_defense() {
    ...
    assert!(result.success_rate < 0.1, "Invalid signature defense failed");
